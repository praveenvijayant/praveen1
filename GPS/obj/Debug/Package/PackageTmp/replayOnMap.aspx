...
<asp:Content ID="Content2" ContentPlaceHolderID="contentdata" runat="Server" onload="initialize()">
    ...
    <telerik:RadSplitter ID="RadSplitter1" runat="server" Width="100%" Height="100%"
        ...
        <telerik:RadPane ID="leftpane" runat="server" SkinID="Transparent" Height="100%">
            <telerik:RadSlidingZone ID="leftSliderZone" runat="server" SlideDirection="right"
                Height="100%" Width="36px" SkinID="Transparent" DockedPaneId="leftSlider">
                <telerik:RadSlidingPane ID="leftSlider" runat="server" Width="280px" SkinID="Transparent"
                    Title="Carriers" IconUrl="~/icons/leftSlider.png" Height="100%">
