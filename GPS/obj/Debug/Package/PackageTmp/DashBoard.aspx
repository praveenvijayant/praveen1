    ...
    <telerik:RadSplitter ID="RadSplitter1" runat="server" Width="100%" Height="100%"
        ...
        <telerik:RadPane ID="leftpane" runat="server" Width="36px" SkinID="Default">
            <telerik:RadSlidingZone ID="leftSliderZone" runat="server" SlideDirection="right"
                Width="36px" DockedPaneId="leftSlider" SkinID="Transparent">
        ...
        <telerik:RadPane ID="middlePane" runat="server" Width="100%" Height="100%" Scrolling="None">
            <telerik:RadDockZone ID="RadDockZoneRight" runat="server" Height="100%" Width="99%">
                <telerik:RadDock ID="track" Title="Live Location" runat="server" Width="100%" Skin="Transparent"
                    ...
                    <ContentTemplate>
                        ...
                        <telerik:RadAjaxPanel ID="RadAjaxPanel4" runat="server" LoadingPanelID="RadAjaxLoadingPanel1"
                            RenderMode="Block">
                            <table style="width: 100%; background-color: ActiveBorder">
                                <tr>
                                    <td>
                                        <telerik:RadComboBox ID="txtVehName" runat="server" Skin="Transparent" EmptyMessage="Select Carrier"
                                    ...
                                    <td>
                                        <asp:UpdatePanel ID="UpdatePanel9" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <telerik:RadButton Skin="Transparent" ID="oldTrack" runat="server" Text="Trace" ToolTip="Plots Track on Google Map Between Specified date range."
                                        ...
                                        <tr>
                                            <td>
                                                <telerik:RadGrid ID="RadGrid1" runat="server" EnableViewState="true" AllowSorting="True"
                                                    Style="width: 100%" GridLines="None" Skin="Transparent" Width="100%" OnSortCommand="RadGrid1_SortCommand">
                                        ...
                                        <telerik:GridBoundColumn DataField="longitude" DataType="System.Double" HeaderText="longitude"
                                            SortExpression="longitude" UniqueName="longitude">
                                                            ...
                                                            <telerik:GridTemplateColumn DataField="Din1" DataType="System.Int32" HeaderText="IGN"
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="Din1Label" runat="server" Text='<%# Eval("Din1").ToString().Equals("")?"NA":(Eval("carrierTypeFId").ToString().Equals("1")||Eval("carrierTypeFId").ToString().Equals("2")?"NA":(Eval("Din1").ToString().Equals("0")?"OFF":"ON")) %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </telerik:GridTemplateColumn>
                                                            <telerik:GridTemplateColumn DataField="Din2" DataType="System.Int32" HeaderText="Door"
                                                                SortExpression="Din2" UniqueName="Din2">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="Din2Label" runat="server" Text='<%#Eval("Din2").ToString().Equals("")?"NA":(Eval("carrierTypeFId").ToString().Equals("1")||Eval("carrierTypeFId").ToString().Equals("2")?"NA":(Eval("Din2").ToString().Equals("0")?"Close":"Open")) %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </telerik:GridTemplateColumn>
