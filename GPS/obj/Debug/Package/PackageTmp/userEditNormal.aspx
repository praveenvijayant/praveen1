<%@ Page Title="" Language="C#" MasterPageFile="~/orgAdmin.Master" AutoEventWireup="true" CodeBehind="userEditNormal.aspx.cs" Inherits="GPS.userEditNormal" %>
                                ...
                                <tr id="trPassword" runat="server">
                                    ...
                                    <td>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtPassword"
                                            ErrorMessage="Password must be atleast 6 or more Characters long." ForeColor="#CC3300"
                                ...
                                <tr>
                                    ...
                                    <td  style="padding-top: 30px">
                                        <asp:Button ID="btnInsert" runat="server" OnClick="btnInsert_Click" Style="height: 26px"
                                            Text="Update" ValidationGroup="save" CssClass="button" TabIndex="7" />
